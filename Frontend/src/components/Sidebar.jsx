  ...
  return (
    ...
    '>
        <nav className='h-full flex flex-col gap-3'>
            ...
            {authUser &&(
                <Link to='/likes' className='p-1.5 flex justify-center transition-colors 
            ...
            {authUser && (
					<Link to='/explore' className='p-1.5  flex justify-center transition-colors 
                    duration-200 rounded-lg hover:bg-gray-800'>
			...
			{!authUser && (
				<Link to='/login' className='p-1.5 focus:outline-nones transition-colors 
                duration-200 rounded-lg hover:bg-gray-800'>
            ...
            {!authUser && (
				<Link to='/signup' className='p-1.5 focus:outline-nones transition-colors 
                duration-200 rounded-lg hover:bg-gray-800'>
